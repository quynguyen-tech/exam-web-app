...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChangepasswordComponent = /** @class */ (function () {
                function ChangepasswordComponent(fb, router, authService, userService) {
                    this.fb = fb;
                    this.router = router;
                ...
                ChangepasswordComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.router.data.subscribe(function (routeData) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var data, _a;
                ...
                ChangepasswordComponent.prototype.resetPassword = function (value) {
                ...
                AuthService.prototype.doLogin = function (value) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, firebase_app__WEBPACK_IMPORTED_MODULE_4__["auth"]().signInWithEmailAndPassword(value.email, value.password)];
                                case 1:
                                    credential = _a.sent();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ExamComponent = /** @class */ (function () {
                function ExamComponent(authService, userService, http, router) {
                    var _this = this;
                    this.authService = authService;
                    this.userService = userService;
                    this.http = http;
                    ...
                    this.getQuestions = function (subjectName) {
                        return _this.http.get("../../assets/" + subjectName + ".json");
                    };
                    this.config = {
                        itemsPerPage: 3,
                        currentPage: 1,
                ...
                ExamComponent.prototype.showModal = function () {
                    this.isSubmitted = true;
                };
                ExamComponent.prototype.onRedirect = function () {
                ...
                ExamComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.router.data.subscribe(function (routerData) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var data, _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                    ...
                    this.router.paramMap.subscribe(function (params) {
                        var id = params.get('subjectId');
                        _this.subjectName = id;
                    });
                    this.getQuestions(this.subjectName).subscribe(function (data) {
                        _this.list = data;
                    });
                ...
                ExamComponent.prototype.onChoose = function (answerId, questionId) {
                    console.log('-----===-=-=-=-==', answerId);
                    var current = this.list.find(function (question) { return question.Id === questionId; });
                ...
                ExamComponent.prototype.submit = function () {
                    var _this = this;
                    this.list.map(function (question) {
                        if (question._answerId) {
                            if (question._answerId === question.AnswerId) {
                                _this.result.mark += question.Marks;
                                _this.result.trueAnswer += 1;
                            }
                        }
                    });
                    this.showModal();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IndexComponent = /** @class */ (function () {
                function IndexComponent(userService, authService, http, router) {
                    this.userService = userService;
                    this.authService = authService;
                    this.http = http;
                    this.router = router;
                ...
                IndexComponent.prototype.checkTime = function (start_time, end_time) {
                    var from = moment__WEBPACK_IMPORTED_MODULE_8__(start_time, 'DD/MM/YYYY HH:mm').unix();
                    var to = moment__WEBPACK_IMPORTED_MODULE_8__(end_time, 'DD/MM/YYYY HH:mm').unix();
                    var current = moment__WEBPACK_IMPORTED_MODULE_8__().unix();
                ...
                IndexComponent.prototype.pageChanged = function (event) {
                    this.config.currentPage = event;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavigationComponent = /** @class */ (function () {
                function NavigationComponent(authservice, userService, router, location) {
                    this.authservice = authservice;
                    this.userService = userService;
                    this.router = router;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UpdateComponent = /** @class */ (function () {
                function UpdateComponent(userService, authService, route, location, fb) {
                    this.userService = userService;
                    this.authService = authService;
                    this.route = route;
                    this.location = location;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    if (!data) return [3 /*break*/, 2];
                                    _a = this;
                                    return [4 /*yield*/, this.getProfile(data.uid)];
                                case 1:
                                    _a.user = _b.sent();
                ...
                UpdateComponent.prototype.getProfile = function (uid) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.userService.getUserProfile(uid)];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        });
                    });
                };
                UpdateComponent.prototype.createForm = function (user) {
                    this.profileForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormGroup"]({
                ...
                UpdateComponent.prototype.save = function (value) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserComponent = /** @class */ (function () {
                ...
                UserComponent.prototype.getProfile = function (uid) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.userService.getUserProfile(uid)];
                ...
                UserComponent.prototype.save = function (value) {
                    var _this = this;
                    this.userService.updateCurrentUser(this.user, value).then(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = this;
                                    return [4 /*yield*/, this.getProfile(localStorage.getItem('uid'))];
                                case 1:
                                    _a.user = _b.sent();
                                    return [2 /*return*/];
                            }
